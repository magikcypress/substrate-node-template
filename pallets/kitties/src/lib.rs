...
pub mod pallet {
	...
	pub struct Kitty<T: Config> {
		pub dna: [u8; 32],   // Using 16 bytes to represent a kitty DNA
	...
	pub struct GenesisConfig<T: Config> {
		pub kitties: Vec<(T::AccountId, [u8; 32], Gender)>,
	}
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn breed_dna(parent1: &T::Hash, parent2: &T::Hash) -> Result<[u8; 32], Error<T>> {
